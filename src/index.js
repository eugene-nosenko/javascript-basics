...
/*
 ...
 Зарпещено использовать встроенные методы для работы с массивами. Использовать instanceof вместо isArray.
 Пример:
...
function isAllTrue(array, fn) {
  if (!(array instanceof Array) || !(array.length)) { // проверка на массив и на длинну
    throw new Error('empty array');
  } else if (typeof (fn) !== 'function') { // проверка на функцию
